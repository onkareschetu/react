                                    ...
                                    <Collapse isOpen={isMutual}>
                                        <CardBody className="social-status filter-cards-view">
                                            ...
                                            <Media>
                                                ...
                                                <Media body>
                                                    <span className="f-w-600 d-block">Bucky Barnes</span><span className="d-block">winter@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <Media body>
                                                    <span className="f-w-600 d-block">Sarah Loren</span><span className="d-block">barnes@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <Media body>
                                                    <span className="f-w-600 d-block">Jason Borne</span><span className="d-block">jasonb@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <div className="social-status social-offline"></div>
                                                <Media body>
                                                    <span className="f-w-600 d-block">Comeren Diaz</span><span className="d-block">comere@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <div className="social-status social-online"></div>
                                                <Media body>
                                                    <span className="f-w-600 d-block">Andew Jon</span><span className="d-block">andrewj@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <div className="social-status social-busy"></div>
                                                <Media body>
                                                    <span className="f-w-600 d-block">Johny Waston</span><span className="d-block">johny@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                ...
                                                <div className="social-status social-offline"></div>
                                                <Media body>
                                                    <span className="f-w-600 d-block">Johny William</span><span className="d-block">johnyw@gmail.com</span>
                                                </Media>
                                            </Media>
                                            <Media>
                                                <img className="img-50 rounded-circle m-r-15" src={two} alt="twoImg" />
