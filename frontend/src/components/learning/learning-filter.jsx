                    ...
                    <Row>
                        ...
                        <Col xl="12">
                            <Card>
                                <CardHeader>
                                    <h5 className="mb-0">
                                        <Button color="link pl-0" onClick={() => setIsDevelopment(!isDevelopment)} data-toggle="collapse" data-target="#collapseicon2" aria-expanded="true" aria-controls="collapseicon2">Upcoming Courses</Button>
                                    </h5>
                                </CardHeader>
                                <Collapse isOpen={isDevelopment}>
                                    <div className="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                                        <CardBody className="upcoming-course">
                                            <Media>
                                                <Media body><span className="f-w-600">UX Development</span><span className="d-block">Course By <a href="#javascript"> Lorem ipsum</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-half-o font-warning"></i></span></Media>
                                                <div>
                                                    <h5 className="mb-0 font-primary">18</h5><span className="d-block">Dec</span>
                                                </div>
                                            </Media>
                                            <Media>
                                                <Media body><span className="f-w-600">Business Analyst</span><span className="d-block">Course By <a href="#javascript">Lorem ipsum </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i></span></Media>
                                                <div>
                                                    <h5 className="mb-0 font-primary">28</h5><span className="d-block">Dec</span>
                                                </div>
                                            </Media>
                                            <Media>
                                                <Media body><span className="f-w-600">Web Development</span><span className="d-block">Course By <a href="#javascript">Lorem ipsum </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-o font-warning"></i></span></Media>
                                                <div>
