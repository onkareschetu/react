                        ...
                        <Col lg="6" className="product-details  text-left">
                          ...
                          <div className="product-qnty">
                            ...
                            <div className="addcart-btn">
                              <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/cart`}><Button color="primary" className="mr-2 mt-2" onClick={() => addcart(singleProduct, quantity)}>Add to Cart</Button></Link>
                              <Button onClick={() => onClickDetailPage(singleProduct)} color="primary" className="mr-2 mt-2">View Details</Button>
                            </div>
                          </div>
                        </Col>
                      </div>
