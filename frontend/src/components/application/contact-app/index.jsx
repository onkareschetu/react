                  ...
                  <CardBody>
                    <div className="email-app-sidebar left-bookmark">
                      ...
                      <Nav className="main-menu contact-options" role="tablist">
                        ...
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Follow up</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Favorites</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Ideas</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Important</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Business</span></a></NavItem>
                        <NavItem><a href="#javascript"  className={activeTab === '2' ? 'active' : ''} onClick={() => setActiveTab('2')}><span className="title">Holidays</span></a></NavItem>
                      </Nav>
                    </div>
                  </CardBody>
                </Card>
                              ...
                              <Col xl="4 xl-50" md="5">
                                <Nav className="flex-column nav-pills">
                                  ...
                                  users.map((user, index) => {
                                    return (
                                      <NavLink  onClick={() => dynamictoggle(index, user)} key={index} >
                                        <div className="media">
