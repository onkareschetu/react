                            ...
                            <Card>
                                ...
                                <Collapse isOpen={isFilter}>
                                    <CardBody className="filter-cards-view animate-chk">
                                        ...
                                        <Button color="primary" className="text-center">Find jobs</Button>
                                    </CardBody>
                                </Collapse>
                            </Card>
                        </Col>
                        ...
                        <Col xl="12">
                            <Card>
                                ...
                                <Collapse isOpen={location}>
                                    ...
                                    <Button className="btn-block text-center" color="primary">All Locations</Button>
                                </Collapse>
                            </Card>
                        </Col>
                        <Col xl="12">
                            <Card>
                                <CardHeader>
                                    <h5 className="mb-0">
                                        <Button color="link pl-0" onClick={() => setisJobTitle(!isJobTitle)}
                                            data-toggle="collapse" data-target="#collapseicon2" aria-expanded={isJobTitle} aria-controls="collapseicon2">Job Title</Button>
                                    </h5>
                                </CardHeader>
                                <Collapse isOpen={isJobTitle}>
                                    ...
                                    <Button className="btn-block text-center" color="primary">All Job Title</Button>
                                </Collapse>
                            </Card>
                        </Col>
                        <Col xl="12">
                            <Card>
                                ...
                                <Collapse isOpen={isIndustry}>
                                    <div className="collapse show" id="collapseicon3" data-parent="#accordion" aria-labelledby="collapseicon3">
                                        ...
                                        <Button className="btn-block text-center" color="primary">All Industries</Button>
                                    </div>
                                </Collapse>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                <CardHeader>
                                    <h5 className="mb-0">
                                        <Button color="link pl-0" onClick={() => setisSkill(!isSkill)}
                                            data-toggle="collapse" data-target="#collapseicon4" aria-expanded={isSkill} aria-controls="collapseicon4">Specific skills</Button>
                                    </h5>
                                </CardHeader>
                                <Collapse isOpen={isSkill}>
                                    <div className="collapse show" id="collapseicon4" data-parent="#accordion" aria-labelledby="collapseicon4">
                                        ...
                                        <Button className="btn-block text-center" color="primary">All Skills</Button>
                                    </div>
                                </Collapse>
                            </Card>
                        </Col>
